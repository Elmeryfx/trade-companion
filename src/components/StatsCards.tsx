...
import { getWinRate, getTotalPnl, getReturns, getProfitFactor, formatCurrency } from "@/lib/analytics";
import { Target, DollarSign, TrendingUp, ArrowUpDown } from "lucide-react";
...
export const StatsCards = ({ trades }: { trades: Trade[] }) => {
  const stats = [
    ...
    { label: "Profit Factor", value: getProfitFactor(trades).toFixed(2), icon: ArrowUpDown },
  ];
