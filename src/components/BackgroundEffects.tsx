export const BackgroundEffects = () => {
  return (
    <div className="fixed inset-0 pointer-events-none z-0" aria-hidden="true">
      ...
      <div
        className="absolute -top-32 -left-32 w-[400px] h-[400px] rounded-full opacity-[0.07] blur-[100px]"
      ...
      <div
        className="absolute top-1/3 -right-20 w-[300px] h-[300px] rounded-full opacity-[0.04] blur-[80px]"
        style={{ background: "var(--base-gradient, linear-gradient(90deg, #00D4FF, #020024))" }}
      />
    </div>
  );
